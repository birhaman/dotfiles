;; sessions.el - Session management
;; Buffer lists
;; (require 'perspective)
;;  (persp-mode-set-prefix-key (kbd "C-c C-w"))
...
;; (require 'workgroups2)
;;   (setq wg-session-file "~/.emacs.d/sessions/.emacs_workgroups")
...
;;   (add-to-list 'worksaces-list deskid)
